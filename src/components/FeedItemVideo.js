...
import { View, Text, Image, Dimensions, AlertIOS, TouchableOpacity, TouchableWithoutFeedback } from "react-native";
        ...
        <View style={styles.feedImgContainer}>
          {props.file_type == "video" ? (
            <TouchableWithoutFeedback onPress={this.playVideo}>
              <Video
                source={{ uri: "http://www.html5videoplayer.net/videos/toystory.mp4" }}
                ref={ref => {
                  this.player = ref;
                }}
