...
class EventsUpNext extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        AsyncStorage.getItem("EventsNext", (err, result) => {
            if (!err && result != null) {
    ...
    gotoEventsView(events_id) {
        this.props.navigation.navigate("EventsView", { events_id: events_id, events_type: 2 });
    }
            ...
            <View style={styles.row}>
                ...
                <TouchableWithoutFeedback onPress={() => this.gotoEventsView(rowData.item.key)}>
                    <View style={styles.eventImageContainer}>
                        ...
                        {rowData.item.puffy_events_rsvp_approve == 1 ? (
                            <View style={styles.statusContainer}>
                                <Image style={styles.statusImage} source={Images.confirmed_guest} />
                                <Text style={styles.statusText}>Confirmed Guest</Text>
                            </View>
                        ) : (
                            <View style={styles.statusContainer}>
                                <Image style={styles.statusImage} source={Images.pending_event} />
            ...
            <View style={styles.container}>
                {this.props.data.row_count == 0 ? (
                    <View style={styles.profileMessage}>
                        ...
                        <Text style={styles.profileMessageHeader}>You have no pending events</Text>
                    </View>
                ) : (
                    <FlatList
